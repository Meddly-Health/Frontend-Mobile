...
abstract class $MedicineCopyWith<$Res> {
  ...
  $Res call({String name, String icon, Method method});
...
class _$_Medicine implements _Medicine {
  const _$_Medicine(
      {required this.name, required this.icon, required this.method});
  ...
  @override
  String toString() {
    return 'Medicine(name: $name, icon: $icon, method: $method)';
  }
...
abstract class _Medicine implements Medicine {
  const factory _Medicine(
      ...
      required final Method method}) = _$_Medicine;
