...
abstract class $TreatmentCopyWith<$Res> {
  ...
  $Res call(
      ...
      Medicine medicine,
      int stock,
      @JsonKey(name: 'stock_warning') int? stockWarning,
...
class _$_Treatment implements _Treatment {
  const _$_Treatment(
      ...
      required this.stock,
      @JsonKey(name: 'stock_warning') required this.stockWarning,
...
abstract class _Treatment implements Treatment {
  const factory _Treatment(
      ...
      @JsonKey(name: 'stock_warning') required final int? stockWarning,
      required final TreatmentIndication treatmentIndication}) = _$_Treatment;
